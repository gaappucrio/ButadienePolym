...
def taxareac(t, Y, Rpar, g, pf):
    ...
    # Baseado na temperatura inicial do reator (T0) lida no exp.dat
    # -------------------------------------------------------------------------
    ...
    if T0_celsius >= 75.0:
        ...
        # Experimento de 60°C (ou padrão caso seja menor)
    ...
    # Termodinâmica (Calculada através dos submódulos)
